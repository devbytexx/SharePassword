...
export function loadConfig() {
  ...
  return {
    ...
    expirePresets: [3600, 10800, 43200, 86400, 604800, 1209600],
    // 25 MB Dateien blähen sich durch doppeltes Base64 (Datei→JSON, dann
    // Ciphertext→Body) auf ~45 MB Request-Body auf. 50 MB deckt das mit
    // Reserve ab. Muss mit nginx client_max_body_size übereinstimmen.
